...
namespace DarwinNet.Exceptions
{
    ...
    public class InvalidDarwinDataException : Exception
    {
        ...
        public InvalidDarwinDataException(string param) : base($"{param} does not have a valid value in the Darwin response. Please contact the developer of DarwinNet.")
        {
        }
    }
