...
{
    [TestFixture]
    internal class GetFastestDeparturesAsyncTest : BaseTest
    {
        [Test]
        public async Task GetFastestDeparturesAsync_ValidParams_ReturnsDeparturesBoardWithValidData()
        {
            ...
            // Act
            var result = await Darwin.Requests.GetFastestDeparturesAsync(station, stationList, timeWindow);
        ...
        public void GetFastestDeparturesAsync_InvalidFilterList_ThrowsArgumentOutOfRangeException()
        {
            ...
            // Act and Assert
            Assert.ThrowsAsync<ArgumentOutOfRangeException>(() => Darwin.Requests.GetFastestDeparturesAsync(station, stationList, timeWindow));
        }
