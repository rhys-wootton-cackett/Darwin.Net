...
namespace Darwin.Net.Exceptions
{
    ...
    public class StationCrsNullException : Exception
    {
        ...
        public StationCrsNullException(Station station) : base($"Station.{Enum.GetName(typeof(Station), station)} does not have a CRS StringValue attached to it. Please contact the developer of Darwin.Net.")
        {
        }
